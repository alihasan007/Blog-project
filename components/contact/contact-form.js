    ...
    async function sendMessageHandler(event) {
        ...
        try {
            await sendContactData({
                email: enteredEmail, name:
                    enteredName, message: enteredMessage
            })
    ...
    return <section className={classes.contact}>
        ...
        <form className={classes.form} onSubmit={sendMessageHandler}>
            ...
            <div className={classes.control}>
                ...
                <textarea id='messagge' rows='5' value={enteredMessage} onChange={event => { setEnteredMessage(event.target.value) }} required />
            </div>
